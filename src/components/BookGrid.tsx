...
export default function BookGrid({
  ...
  const trendingLimit = bestsellingBooks;
  const featuredLimit = featuredBooks;
    ...
    <div className="w-full bg-[#FAFAF9] pb-20 font-sans" id="books-store-section">
      {!isSearchActive && selectedCategory === 'all' ? (
        ...
        <div className="w-full">
          ...
          {trendingLimit && trendingLimit.length > 0 && (<section className="w-full bg-white border-b border-slate-100 py-10 px-8">
          ...
          {featuredLimit && featuredLimit.length > 0 && (<section className="w-full bg-[#FAFAF9] py-10 px-8">
            <div className="max-w-7xl mx-auto relative group">
              <div className="flex items-center justify-between mb-6">
                <div className="flex flex-col">
                  <h3 className="text-xs sm:text-sm font-black text-brand-pine tracking-wider uppercase font-serif">
